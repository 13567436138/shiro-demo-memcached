...
import com.mark.demo.shiro_memched.exception.JedisHandleException;
...
public class JedisUtils
{
    ...
    // 从spring引入，可以�?�虑编码实现，避免对spring的依�?
    ...
    public static String set(String key, String value, int cacheSeconds)
    {
        ...
        try
        {
            ...
            if (cacheSeconds != 0)
            {
                jedis.expire(key, cacheSeconds);// 这里返回的是long，如果为1估计是成功，但具体意义在源码里没有找到注�?
            }
        }
    ...
    /**
     * 从Redis集群中根据CRC16算法获取当前key对象的Redis服务器操作对�?
     * @param key 缓存key�?
     * @return Jedis Jedis
     */
