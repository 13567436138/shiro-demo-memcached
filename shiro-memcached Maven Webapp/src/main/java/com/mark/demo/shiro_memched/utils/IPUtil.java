...
public class IPUtil
{
    ...
    protected final int            MODE_2          = 0x02;                                      // 重定向国家记录，有地区记�?
    ...
    { // 采用二分法查�?
        ...
        return long2StringIP(readLong(4, indexBegin + middle * 7)) + ","// 匹配到的IP地址(�?)
                + result[0] + "," // 国家
                + result[1];// 地区
    }
    ...
    // 字符串格式的IP地址转化�?32位整型格式的IP地址(little-endian)
