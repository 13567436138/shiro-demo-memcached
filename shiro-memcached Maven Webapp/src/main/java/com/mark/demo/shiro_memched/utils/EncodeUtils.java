...
import com.mark.demo.shiro_memched.exception.NoByteException;
...
public class EncodeUtils
{
    ...
    public static int stringHexToInt(char c) throws NoByteException
    {
        ...
        if (value == -1) { throw new NoByteException("必须是十六进制字�?"); }
        return value;
    }
    ...
    public static String getXorString(String str, String charset)
    {
        ...
        if (null != bt)
        {
            ...
            // 转换�?16进制字符�?
            // int�?32位，byte�?8位，不进�?&0xff时会出现�?24位补位误差，产生0xffffff
