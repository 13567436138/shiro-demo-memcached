...
import com.mark.demo.shiro_memched.constant.ApplicationConst;
import com.mark.demo.shiro_memched.constant.ClientConst;
import com.mark.demo.shiro_memched.constant.CommonConst;
import com.mark.demo.shiro_memched.entity.ClientParameter;
import com.mark.demo.shiro_memched.entity.EnumDescribable;
import com.mark.demo.shiro_memched.exception.BusinessException;
...
public class ParameterUtils
{
     ...
     * @return EnumDescribable 参数�?查结果，相关描述参靠ClientConst
     */
    ...
    /**
     * 校验数据长度
     * @param dataLen 客户端请求中的长度参�?
     * @param data 客户端请求中的实际数�?
     * @return
     * @author 夏铭
     */
    ...
    /**
     * 从ClientParameter对象获取参数键�?�对，返回Map<String, String>
     * @param parameter ClientParameter
    ...
    /**
     * 接收并解析消息体：根据消息体内容，取得Map<String,String>键�?�对
     * @param data 消息体内�?
     * @return Map<String, String> Map<String, String>
     */
    ...
    /**
     * 任意条件动�?�查询接口处理方法：将请求参数中的json查询参数转化为Map<String,Object>
     * 如：{"userAge":"1","userName":"�?"}
     * @param json 接收到的json查询参数
     * @return Map<String, Object> Map<String, Object>该返回�?�可以直接传给GenericDao
     */
    ...
    /**
     * 用于包装数据库模糊查询时的字符串参数�? 比如传入 "123", 会返�? "%123%"
