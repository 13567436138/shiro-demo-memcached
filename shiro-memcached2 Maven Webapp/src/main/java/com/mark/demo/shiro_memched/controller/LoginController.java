...
import com.mark.demo.shiro_memched.base.GenericController;
import com.mark.demo.shiro_memched.constant.CharsetConst;
import com.mark.demo.shiro_memched.constant.CommonConst;
import com.mark.demo.shiro_memched.entity.JsonMessage;
import com.mark.demo.shiro_memched.entity.User;
import com.mark.demo.shiro_memched.session.MemcachedSessionManager;
import com.mark.demo.shiro_memched.utils.IPUtil;
import com.mark.demo.shiro_memched.utils.JsonMessageUtils;
import com.mark.demo.shiro_memched.utils.OnLineUserUtils;
...
public class LoginController extends GenericController
{
    ...
    public JsonMessage login(User userInfo, HttpServletRequest request, String captcha)
    {
        ...
        {
            // 判断验证码
            String sessionCaptcha = redisSessionManager.getString(request, MemcachedSessionManager.SessionKey.CAPTCHA);
    ...
    {
        // 清理自定义会话
        MemcachedSessionManager.clear(request, response);
        Subject currentUser = SecurityUtils.getSubject();
